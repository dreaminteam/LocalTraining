...
public class Test {
	...
	public static void main(String[] args) {
		...
		final String pathKeyWords = "keywords.txt";
		final String outStream = "outStream.txt";
		...
		final String fileUTF_8 = "file-utf-8.txt";
		final String fileUTF_16 = "file-utf-16.txt";
